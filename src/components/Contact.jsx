...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "6b40e936-af84-4557-807b-7be5ca613360");
    ...
    <div className=' text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
        ...
        <form onSubmit={onSubmit} className=' max-w-2xl mx-auto text-gray-600 pt-8'>
            ...
            <div className=' my-6 text-left'>
                Message
                <textarea className='w-full border border-gray-300 rounded py-3 px-4 mt-2 h-48 resize-none' name="Message" placeholder='Write a Message..' required></textarea>
            </div>
